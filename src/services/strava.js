...
const MOCK_ACTIVITIES = [
    ...
    { id: 2, name: 'Commute to Work', distance: 12500, moving_time: 1800, type: 'Ride', athlete: { firstname: 'Mike', lastname: 'B.' } },
    { id: 3, name: 'Lunch Run', distance: 5000, moving_time: 1500, type: 'Run', athlete: { firstname: 'Jenny', lastname: 'C.' } },
    { id: 4, name: 'Sunday Cafe Ride', distance: 80000, moving_time: 10800, type: 'Ride', athlete: { firstname: 'Tom', lastname: 'H.' } },
];
